...
parser.add_argument('--normal_smooth_loss_weight', type=float, default=0.03, help='normal smoothness loss weight')
parser.add_argument('--curv_loss_weight', type=float, default=0.01, help='curvature continuity loss weight')
...
def train_sample(model, model_loss, optimizer, sample, args):
    ...
    loss, depth_loss, loss_extra = model_loss(outputs, depth_gt_ms, mask_ms, **loss_kwargs(sample_cuda, args))
